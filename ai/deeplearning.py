...
model_save_path = os.path.join(os.path.dirname(__file__),'vgg16_finetuned.h5')
test_data_save_path = os.path.join(os.path.dirname(__file__), 'test_data.npz')

# Modeli kaydet
model.save(model_save_path)

# Test verilerini kaydet
np.savez(test_data_save_path, X_test=X_test, y_test=y_test)
